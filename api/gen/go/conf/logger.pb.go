...
func (x *Logger_Logrus) Reset() {
	*x = Logger_Logrus{}
	mi := &file_conf_logger_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger_Logrus) Descriptor() ([]byte, []int) {
	return file_conf_logger_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *Logger_Fluent) Reset() {
	*x = Logger_Fluent{}
	mi := &file_conf_logger_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger_Fluent) Descriptor() ([]byte, []int) {
	return file_conf_logger_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *Logger_Aliyun) Reset() {
	*x = Logger_Aliyun{}
	mi := &file_conf_logger_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger_Aliyun) Descriptor() ([]byte, []int) {
	return file_conf_logger_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *Logger_Tencent) Reset() {
	*x = Logger_Tencent{}
	mi := &file_conf_logger_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger_Tencent) Descriptor() ([]byte, []int) {
	return file_conf_logger_proto_rawDescGZIP(), []int{0, 4}
}
...
type Logger_Zerolog struct {
	...
	Filepath           string                 `protobuf:"bytes,7,opt,name=filepath,proto3" json:"filepath,omitempty"`                                                 // 当writer为file时，指定日志文件地址
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *Logger_Zerolog) Reset() {
	*x = Logger_Zerolog{}
	mi := &file_conf_logger_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger_Zerolog) Descriptor() ([]byte, []int) {
	return file_conf_logger_proto_rawDescGZIP(), []int{0, 5}
}
...
const file_conf_logger_proto_rawDesc = "" +
	...
	"\n" +
	"\b_zerologBw\n" +
	"\bcom.confB\vLoggerProtoP\x01Z.github.com/liujitcn/kratos-kit/api/gen/go/conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"

var (
	file_conf_logger_proto_rawDescOnce sync.Once
	file_conf_logger_proto_rawDescData []byte
)

func file_conf_logger_proto_rawDescGZIP() []byte {
	file_conf_logger_proto_rawDescOnce.Do(func() {
		file_conf_logger_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_conf_logger_proto_rawDesc), len(file_conf_logger_proto_rawDesc)))
	})
	return file_conf_logger_proto_rawDescData
}

var file_conf_logger_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_conf_logger_proto_goTypes = []any{
...
func file_conf_logger_proto_init() {
	...
	file_conf_logger_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_conf_logger_proto_rawDesc), len(file_conf_logger_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
