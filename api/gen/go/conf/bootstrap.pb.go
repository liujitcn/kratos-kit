...
func (x *Bootstrap) Reset() {
	*x = Bootstrap{}
	mi := &file_conf_bootstrap_proto_msgTypes[0]
...
func (*Bootstrap) Descriptor() ([]byte, []int) {
	return file_conf_bootstrap_proto_rawDescGZIP(), []int{0}
}
...
var File_conf_bootstrap_proto protoreflect.FileDescriptor

const file_conf_bootstrap_proto_rawDesc = "" +
	"\n" +
	"\x14conf/bootstrap.proto\x12\x04conf\x1a\x11conf/server.proto\x1a\x11conf/client.proto\x1a\x0fconf/data.proto\x1a\x11conf/tracer.proto\x1a\x11conf/logger.proto\x1a\x13conf/registry.proto\x1a\x11conf/config.proto\x1a\x0econf/oss.proto\x1a\x10conf/pprof.proto\x1a\x11conf/notify.proto\x1a\x10conf/authn.proto\x1a\x10conf/authz.proto\"\x8f\x05\n" +
	"\tBootstrap\x12)\n" +
	...
	"\x06config\x18\a \x01(\v2\f.conf.ConfigH\x06R\x06config\x88\x01\x01\x12 \n" +
	...
	"\x05pprof\x18\f \x01(\v2\v.conf.PprofH\vR\x05pprof\x88\x01\x01B\t\n" +
	"\a_serverB\t\n" +
	"\a_clientB\a\n" +
	"\x05_dataB\b\n" +
	"\x06_traceB\t\n" +
	...
	"\x06_authzB\b\n" +
	"\x06_pprofBz\n" +
	"\bcom.confB\x0eBootstrapProtoP\x01Z.github.com/liujitcn/kratos-kit/api/gen/go/conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"

var (
	file_conf_bootstrap_proto_rawDescOnce sync.Once
	file_conf_bootstrap_proto_rawDescData []byte
)

func file_conf_bootstrap_proto_rawDescGZIP() []byte {
	file_conf_bootstrap_proto_rawDescOnce.Do(func() {
		file_conf_bootstrap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_conf_bootstrap_proto_rawDesc), len(file_conf_bootstrap_proto_rawDesc)))
	})
	return file_conf_bootstrap_proto_rawDescData
}

var file_conf_bootstrap_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_conf_bootstrap_proto_goTypes = []any{
...
var file_conf_bootstrap_proto_depIdxs = []int32{
	...
	7,  // 6: conf.Bootstrap.config:type_name -> conf.Config
	...
	12, // 11: conf.Bootstrap.pprof:type_name -> conf.Pprof
...
func init() { file_conf_bootstrap_proto_init() }
func file_conf_bootstrap_proto_init() {
	if File_conf_bootstrap_proto != nil {
		return
	}
	file_conf_server_proto_init()
	file_conf_client_proto_init()
	file_conf_data_proto_init()
	file_conf_tracer_proto_init()
	file_conf_logger_proto_init()
	file_conf_registry_proto_init()
	file_conf_config_proto_init()
	file_conf_oss_proto_init()
	file_conf_pprof_proto_init()
	file_conf_notify_proto_init()
	file_conf_authn_proto_init()
	file_conf_authz_proto_init()
	file_conf_bootstrap_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_conf_bootstrap_proto_rawDesc), len(file_conf_bootstrap_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_conf_bootstrap_proto_goTypes,
		DependencyIndexes: file_conf_bootstrap_proto_depIdxs,
		MessageInfos:      file_conf_bootstrap_proto_msgTypes,
	}.Build()
	File_conf_bootstrap_proto = out.File
	file_conf_bootstrap_proto_goTypes = nil
	file_conf_bootstrap_proto_depIdxs = nil
}
