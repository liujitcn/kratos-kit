...
func (x *Registry_Nacos) Reset() {
	*x = Registry_Nacos{}
	mi := &file_conf_registry_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Nacos) Descriptor() ([]byte, []int) {
	return file_conf_registry_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *Registry_Kubernetes) Reset() {
	*x = Registry_Kubernetes{}
	mi := &file_conf_registry_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Kubernetes) Descriptor() ([]byte, []int) {
	return file_conf_registry_proto_rawDescGZIP(), []int{0, 4}
}
...
func (x *Registry_Eureka) Reset() {
	*x = Registry_Eureka{}
	mi := &file_conf_registry_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Eureka) Descriptor() ([]byte, []int) {
	return file_conf_registry_proto_rawDescGZIP(), []int{0, 5}
}
...
func (x *Registry_Polaris) Reset() {
	*x = Registry_Polaris{}
	mi := &file_conf_registry_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Polaris) Descriptor() ([]byte, []int) {
	return file_conf_registry_proto_rawDescGZIP(), []int{0, 6}
}
...
func (x *Registry_Servicecomb) Reset() {
	*x = Registry_Servicecomb{}
	mi := &file_conf_registry_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Servicecomb) Descriptor() ([]byte, []int) {
	return file_conf_registry_proto_rawDescGZIP(), []int{0, 7}
}
...
const file_conf_registry_proto_rawDesc = "" +
	"\n" +
	"\x13conf/registry.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\"\xdf\x0f\n" +
	"\bRegistry\x12\x12\n" +
	...
	"\b_polarisB\x0e\n" +
	"\f_servicecombBy\n" +
	"\bcom.confB\rRegistryProtoP\x01Z.github.com/liujitcn/kratos-kit/api/gen/go/conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"

var (
	file_conf_registry_proto_rawDescOnce sync.Once
	file_conf_registry_proto_rawDescData []byte
)

func file_conf_registry_proto_rawDescGZIP() []byte {
	file_conf_registry_proto_rawDescOnce.Do(func() {
		file_conf_registry_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_conf_registry_proto_rawDesc), len(file_conf_registry_proto_rawDesc)))
	})
	return file_conf_registry_proto_rawDescData
}

var file_conf_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_conf_registry_proto_init() {
	...
	file_conf_registry_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_conf_registry_proto_rawDesc), len(file_conf_registry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
