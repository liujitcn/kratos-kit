...
type TLS struct {
	...
	Domain             string                 `protobuf:"bytes,6,opt,name=domain,proto3" json:"domain,omitempty"` //https对应的域名
...
func (x *TLS) Reset() {
	*x = TLS{}
	mi := &file_conf_tls_proto_msgTypes[0]
...
func (*TLS) Descriptor() ([]byte, []int) {
	return file_conf_tls_proto_rawDescGZIP(), []int{0}
}
...
func (x *TLS_File) Reset() {
	*x = TLS_File{}
	mi := &file_conf_tls_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TLS_File) Descriptor() ([]byte, []int) {
	return file_conf_tls_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *TLS_Config) Reset() {
	*x = TLS_Config{}
	mi := &file_conf_tls_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TLS_Config) Descriptor() ([]byte, []int) {
	return file_conf_tls_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_conf_tls_proto protoreflect.FileDescriptor

const file_conf_tls_proto_rawDesc = "" +
	"\n" +
	"\x0econf/tls.proto\x12\x04conf\"\xd4\x03\n" +
	"\x03TLS\x12'\n" +
	...
	"\x05_fileB\t\n" +
	"\a_configBt\n" +
	"\bcom.confB\bTlsProtoP\x01Z.github.com/liujitcn/kratos-kit/api/gen/go/conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"

var (
	file_conf_tls_proto_rawDescOnce sync.Once
	file_conf_tls_proto_rawDescData []byte
)

func file_conf_tls_proto_rawDescGZIP() []byte {
	file_conf_tls_proto_rawDescOnce.Do(func() {
		file_conf_tls_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_conf_tls_proto_rawDesc), len(file_conf_tls_proto_rawDesc)))
	})
	return file_conf_tls_proto_rawDescData
}

var file_conf_tls_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_conf_tls_proto_goTypes = []any{
	(*TLS)(nil),        // 0: conf.TLS
	(*TLS_File)(nil),   // 1: conf.TLS.File
	(*TLS_Config)(nil), // 2: conf.TLS.Config
}
var file_conf_tls_proto_depIdxs = []int32{
...
func init() { file_conf_tls_proto_init() }
func file_conf_tls_proto_init() {
	if File_conf_tls_proto != nil {
		return
	}
	file_conf_tls_proto_msgTypes[0].OneofWrappers = []any{}
	file_conf_tls_proto_msgTypes[1].OneofWrappers = []any{}
	file_conf_tls_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_conf_tls_proto_rawDesc), len(file_conf_tls_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_conf_tls_proto_goTypes,
		DependencyIndexes: file_conf_tls_proto_depIdxs,
		MessageInfos:      file_conf_tls_proto_msgTypes,
	}.Build()
	File_conf_tls_proto = out.File
	file_conf_tls_proto_goTypes = nil
	file_conf_tls_proto_depIdxs = nil
}
