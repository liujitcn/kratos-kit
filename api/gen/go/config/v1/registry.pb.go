...
type Registry struct {
	...
	Zookeeper *Registry_ZooKeeper `protobuf:"bytes,4,opt,name=zookeeper,proto3,oneof" json:"zookeeper,omitempty"`
	// nacos 为 Nacos 注册发现配置。
	Nacos *Registry_Nacos `protobuf:"bytes,5,opt,name=nacos,proto3,oneof" json:"nacos,omitempty"`
	// kubernetes 为 Kubernetes 注册发现配置。
	Kubernetes *Registry_Kubernetes `protobuf:"bytes,6,opt,name=kubernetes,proto3,oneof" json:"kubernetes,omitempty"`
	...
	Polaris *Registry_Polaris `protobuf:"bytes,8,opt,name=polaris,proto3,oneof" json:"polaris,omitempty"`
	// servicecomb 为 ServiceComb 注册发现配置。
	Servicecomb   *Registry_Servicecomb `protobuf:"bytes,9,opt,name=servicecomb,proto3,oneof" json:"servicecomb,omitempty"`
...
type Registry_Nacos struct {
	...
	BeatInterval *durationpb.Duration `protobuf:"bytes,21,opt,name=beat_interval,json=beatInterval,proto3" json:"beat_interval,omitempty"`
	// listen_interval 为监听间隔时间。
	ListenInterval *durationpb.Duration `protobuf:"bytes,22,opt,name=listen_interval,json=listenInterval,proto3" json:"listen_interval,omitempty"`
	// update_thread_num 为更新服务的线程数。
	UpdateThreadNum int32 `protobuf:"varint,30,opt,name=update_thread_num,json=updateThreadNum,proto3" json:"update_thread_num,omitempty"`
	// not_load_cache_at_start 表示启动时是否不读取本地缓存。
	NotLoadCacheAtStart bool `protobuf:"varint,40,opt,name=not_load_cache_at_start,json=notLoadCacheAtStart,proto3" json:"not_load_cache_at_start,omitempty"`
	// update_cache_when_empty 表示服务列表为空时是否更新本地缓存。
	UpdateCacheWhenEmpty bool `protobuf:"varint,41,opt,name=update_cache_when_empty,json=updateCacheWhenEmpty,proto3" json:"update_cache_when_empty,omitempty"`
	// open_kms 表示是否开启 KMS 加密。
	OpenKms bool `protobuf:"varint,42,opt,name=open_kms,json=openKms,proto3" json:"open_kms,omitempty"`
	// log_level 为日志等级。
	LogLevel string `protobuf:"bytes,50,opt,name=log_level,json=logLevel,proto3" json:"log_level,omitempty"`
	// log_dir 为日志目录。
	LogDir string `protobuf:"bytes,51,opt,name=log_dir,json=logDir,proto3" json:"log_dir,omitempty"`
	// cache_dir 为缓存目录。
	CacheDir string `protobuf:"bytes,52,opt,name=cache_dir,json=cacheDir,proto3" json:"cache_dir,omitempty"`
	// context_path 为上下文路径。
	ContextPath   string `protobuf:"bytes,53,opt,name=context_path,json=contextPath,proto3" json:"context_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Registry_Nacos) Reset() {
	*x = Registry_Nacos{}
	mi := &file_config_v1_registry_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Nacos) Descriptor() ([]byte, []int) {
	return file_config_v1_registry_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *Registry_Kubernetes) Reset() {
	*x = Registry_Kubernetes{}
	mi := &file_config_v1_registry_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Kubernetes) Descriptor() ([]byte, []int) {
	return file_config_v1_registry_proto_rawDescGZIP(), []int{0, 4}
}
...
func (x *Registry_Eureka) Reset() {
	*x = Registry_Eureka{}
	mi := &file_config_v1_registry_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Eureka) Descriptor() ([]byte, []int) {
	return file_config_v1_registry_proto_rawDescGZIP(), []int{0, 5}
}
...
func (x *Registry_Polaris) Reset() {
	*x = Registry_Polaris{}
	mi := &file_config_v1_registry_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Polaris) Descriptor() ([]byte, []int) {
	return file_config_v1_registry_proto_rawDescGZIP(), []int{0, 6}
}
...
func (x *Registry_Servicecomb) Reset() {
	*x = Registry_Servicecomb{}
	mi := &file_config_v1_registry_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Registry_Servicecomb) Descriptor() ([]byte, []int) {
	return file_config_v1_registry_proto_rawDescGZIP(), []int{0, 7}
}
...
const file_config_v1_registry_proto_rawDesc = "" +
	...
	"\x04etcd\x18\x03 \x01(\v2\x18.config.v1.Registry.EtcdH\x01R\x04etcd\x88\x01\x01\x12@\n" +
	"\tzookeeper\x18\x04 \x01(\v2\x1d.config.v1.Registry.ZooKeeperH\x02R\tzookeeper\x88\x01\x01\x124\n" +
	"\x05nacos\x18\x05 \x01(\v2\x19.config.v1.Registry.NacosH\x03R\x05nacos\x88\x01\x01\x12C\n" +
	"\n" +
	"kubernetes\x18\x06 \x01(\v2\x1e.config.v1.Registry.KubernetesH\x04R\n" +
	...
	"\n" +
	"\b_polarisB\x0e\n" +
	"\f_servicecombB\xa1\x01\n" +
	"\rcom.config.v1B\rRegistryProtoP\x01Z<github.com/liujitcn/kratos-kit/api/gen/go/config/v1;configv1\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
	"Config::V1b\x06proto3"

var (
	file_config_v1_registry_proto_rawDescOnce sync.Once
	file_config_v1_registry_proto_rawDescData []byte
)

func file_config_v1_registry_proto_rawDescGZIP() []byte {
	file_config_v1_registry_proto_rawDescOnce.Do(func() {
		file_config_v1_registry_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_v1_registry_proto_rawDesc), len(file_config_v1_registry_proto_rawDesc)))
	})
	return file_config_v1_registry_proto_rawDescData
}

var file_config_v1_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_config_v1_registry_proto_goTypes = []any{
	...
	(*Registry_ZooKeeper)(nil),   // 3: config.v1.Registry.ZooKeeper
	(*Registry_Nacos)(nil),       // 4: config.v1.Registry.Nacos
	(*Registry_Kubernetes)(nil),  // 5: config.v1.Registry.Kubernetes
	(*Registry_Eureka)(nil),      // 6: config.v1.Registry.Eureka
	(*Registry_Polaris)(nil),     // 7: config.v1.Registry.Polaris
	(*Registry_Servicecomb)(nil), // 8: config.v1.Registry.Servicecomb
...
var file_config_v1_registry_proto_depIdxs = []int32{
	...
	3,  // 2: config.v1.Registry.zookeeper:type_name -> config.v1.Registry.ZooKeeper
	4,  // 3: config.v1.Registry.nacos:type_name -> config.v1.Registry.Nacos
	5,  // 4: config.v1.Registry.kubernetes:type_name -> config.v1.Registry.Kubernetes
	6,  // 5: config.v1.Registry.eureka:type_name -> config.v1.Registry.Eureka
	7,  // 6: config.v1.Registry.polaris:type_name -> config.v1.Registry.Polaris
	8,  // 7: config.v1.Registry.servicecomb:type_name -> config.v1.Registry.Servicecomb
	9,  // 8: config.v1.Registry.ZooKeeper.timeout:type_name -> google.protobuf.Duration
	9,  // 9: config.v1.Registry.Nacos.timeout:type_name -> google.protobuf.Duration
	9,  // 10: config.v1.Registry.Nacos.beat_interval:type_name -> google.protobuf.Duration
	9,  // 11: config.v1.Registry.Nacos.listen_interval:type_name -> google.protobuf.Duration
	9,  // 12: config.v1.Registry.Eureka.heartbeat_interval:type_name -> google.protobuf.Duration
	9,  // 13: config.v1.Registry.Eureka.refresh_interval:type_name -> google.protobuf.Duration
...
func file_config_v1_registry_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_registry_proto_rawDesc), len(file_config_v1_registry_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
