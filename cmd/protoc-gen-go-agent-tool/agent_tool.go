...
func generateServiceAgentTools(g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P(formatTypeComment("New"+serviceName+"AgentTools", cmdutils.NormalizeCommentText(service.Comments.Leading)))
	...
	for _, method := range service.Methods {
		...
		toolVar := cmdutils.Unexport(method.GoName) + "Tool"
...
func generateMethodAgentTool(g *protogen.GeneratedFile, service *protogen.Service, method *protogen.Method) {
	...
	g.P(formatMethodComment("New"+service.GoName+method.GoName+"AgentTool", cmdutils.NormalizeCommentText(method.Comments.Leading)))
...
func formatTypeComment(name, comment string) string {
	...
	return cmdutils.FormatToolActionComment(name, comment, "创建", "Agent Tool")
}
