...
func TestIntegrationProtoCompilation(t *testing.T) {
	...
	t.Run("generate_redaction_code", func(t *testing.T) {
		...
		assert.Contains(t, contentStr, "RegisterRedactedTestServiceWithBypass", "Custom bypass registration should be explicit")
		assert.Contains(t, contentStr, "RedactedTestServiceWithBypass", "Custom bypass wrapper should be explicit")
