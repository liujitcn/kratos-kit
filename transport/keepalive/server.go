...
func (s *Server) Start(_ context.Context) error {
	...
	log.Info("server listening", "kind", s.serviceKind, "addr", s.lis.Addr().String())
...
func (s *Server) Stop(_ context.Context) error {
	...
	log.Info("server stopping", "kind", s.serviceKind)
	...
	log.Info("service stopped", "kind", s.serviceKind)
