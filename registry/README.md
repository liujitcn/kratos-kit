...
下列签名基于包内部定义，`conf` 为项目配置类型，返回类型基于 `github.com/go-kratos/kratos/v3/registry`。

- `type RegistrarFactory func(cfg *configv1.Registry) (registry.Registrar, error)`
...
- `NewRegistrar(name string, cfg *configv1.Registry) (registry.Registrar, error)`
- `ListRegistrarFactories() []string`

- `type DiscoveryFactory func(cfg *configv1.Registry) (registry.Discovery, error)`
...
- `NewDiscovery(name string, cfg *configv1.Registry) (registry.Discovery, error)`
...
func NewRegistry(cfg *configv1.Registry) (kRegistry.Registrar, error) {
	return bRegistry.NewRegistrar(cfg)
}

// NewDiscovery 创建一个发现客户端
func NewDiscovery(cfg *configv1.Registry) (kRegistry.Discovery, error) {
